...
BASE_DIR = path.dirname("/home/maibyssl/Ariel/data/")

SISPI_DIR = path.join(BASE_DIR, '/sispi/')
CMORPH_DIR = path.join(BASE_DIR, '/cmorph/')
print(BASE_DIR)
...
def leer_sispi():  
  v = ["RAINC", "RAINSH"]
  #f = path.join(SISPI_DIR, "wrfout_d03")
  p = NetCDF("/home/maibyssl/Ariel/data/sispi/wrfout_d03")
  print(p.Variables(v))
