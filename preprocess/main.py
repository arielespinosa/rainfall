...
def files_list():
    ...
    return [abspath(arch.path) for arch in scandir(SISPI_DIR) if arch.is_file()] #  """ and arch.name != script.py """]
...
class MyThread(threading.Thread):
    def __init__(self, file):
        ...
        self.dir = os.path.join(SISPI_DIR, new_dir)
